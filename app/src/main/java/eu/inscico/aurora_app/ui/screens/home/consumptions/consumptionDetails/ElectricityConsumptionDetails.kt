...
fun ElectricityConsumptionDetails(
    ...
    Column(
        ...
        val costsText = if(consumption.electricity.costs != null){
            "${String.format("%.1f",consumption.electricity.costs)} kWh"
        } else {
            "- kWh"
        }
        ...
        ListItem(
            ...
            trailingContent = {
                Text(text = CalendarUtils.toDateString(consumption.electricity.startDate), color = MaterialTheme.colorScheme.onSurfaceVariant, style = MaterialTheme.typography.bodyMedium)
            }
        )
        ...
        ListItem(
            ...
            trailingContent = {
                Text(text = CalendarUtils.toDateString(consumption.electricity.endDate), color = MaterialTheme.colorScheme.onSurfaceVariant, style = MaterialTheme.typography.bodyMedium)
            }
        )
