...
class AddConsumptionViewModel(
    ...
    private fun getSpinnerSectionsOfTransportation(context: Context): List<SpinnerItem.Section<TransportationType>> {
        return listOf(
            ...
            SpinnerItem.Section(section = TransportationTypeSection.AVIATION, name = context.getString(R.string.home_add_consumption_transportation_type_section_aviation_title), entries = listOf(TransportationType.PLANE, TransportationType.PLANE_INTRA_EU, TransportationType.PLANE_EXTRA_EU )),
